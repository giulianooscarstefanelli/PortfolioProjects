...
app.config["JWT_SECRET_KEY"] = "put_a_secret_key"  # Change this!
    ...
    def post(self):
        ...
        if args['characterId'] in list(data['Character ID']):
            ...
            if (args['characterName'] is None) and (args['number_comics'] is None) and (args['number_events'] is None) and (args['number_series'] is None) and (args['highest_price'] is None): 
                ...
                # As one should not share their private key, I have deleted my public and private keys. 
                # If you wish to run the code, please make sure to sign up on the Marvel API and get your private key. 
                # Here's the link to Marvel Developer Portal: https://developer.marvel.com/
